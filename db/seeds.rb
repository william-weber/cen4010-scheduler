...
#
#
User.create!( :n_number => 'n00000000', :password => 'password123', :password_confirmation => 'password123', :first_name => 'Temp', :last_name => 'Admin', :email => 'temp@admin.temp', :is_admin => true)
